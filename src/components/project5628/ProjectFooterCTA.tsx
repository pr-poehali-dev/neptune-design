    ...
    <section className="py-24 bg-foreground text-white">
      <div className="container mx-auto px-6 md:px-12 text-center">
        ...
        <p className="text-white/60 mb-12 max-w-lg mx-auto">
          Каждый участок уникален — грунт, рельеф, инфраструктура влияют на итоговую цену.
          Оставьте заявку и получите персональную смету.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          ...
          <a
            ...
            className="border border-white/30 text-white px-10 py-4 text-sm hover:bg-white/10 transition-colors w-full sm:w-auto text-center"
          >
